...
class Player(object):
    __slots__ = ('player_name', 'player_id', 'is_AI',\
                ...
                'invincible_time', 'uncontrollable_time', 'attack_power', 'attack_cool_down_time', 'attack_cool_down',\
                'jump_quota', 'direction', 'position', 'velocity', 'normal_speed', 'jump_speed',\
                'last_being_attacked_by', 'last_being_collided_with',\
                'last_being_attacked_time_elapsed', 'last_being_collided_time_elapsed',\
                'KO_amount', 'die_amount',\
                'KO_score', 'die_score', 'just_too_good_score', 'just_a_nerd_score',\
                'score', 'rank')
