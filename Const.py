...
GRAVITY_ACCELERATION_FOR_ENTITY = 40 * FPS
...
BANANA_PEEL_DROP_ANGLE = [0, 3, 10]
BANANA_PEEL_DROP_SPEED = [180 * FPS, 120 * FPS, 60 * FPS]
...
BANANA_BOMB_RADIUS = 8
BANANA_BOMB_TIME = 2 * FPS
...
BANANA_BOMB_MACHINE_RADIUS = 8
BANANA_BOMB_MACHINE_VELOCITY = {
    'right' : pg.Vector2(100, 0),
    'down' : pg.Vector2(0, 100),
    'up': pg.Vector2(0, -100)
}
BANANA_BOMB_EMERGE_TIME_RANGE = (FPS, 6 * FPS)
